    ...
    # ------------- DASHBOARD ----------------
        ...
        if role == "HeadTeacher":
            ...
            with tab2:
                ...
                grid_df, date_cols = get_attendance_grid(all_users["username"].tolist(), days=30)
        ...
        # --- TEACHER DASHBOARD ---
            ...
            with tab3:
                ...
                st.dataframe(load_attendance()[load_attendance()["username"].isin(view_usernames)], use_container_width=True)
            with tab4:
